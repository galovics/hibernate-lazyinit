...
public class FetchLazyCollectionWithinTransactionApplication {
    private static final Logger logger = LoggerFactory.getLogger(FetchLazyCollectionWithinTransactionApplication.class);
    ...
    public static void main(final String[] args) {
        ...
        helper.doInTransaction(entityManager -> {
            ...
            logger.info("Got the Company object. The products collection is not loaded yet.");
